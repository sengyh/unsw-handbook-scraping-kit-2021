...
class Course(Base):
  ...
  other_requirements = Column(postgresql.JSONB)
...
class Specialisation(Base):
  ...
  type = Column(String)
  credits = Column(Integer)
  course_structure = Column(postgresql.ARRAY(postgresql.JSONB))
  more_information = Column(postgresql.ARRAY(postgresql.JSONB))
  school = Column(String, ForeignKey('schools.name'))
...
class Program(Base):
  ...
  core_specialisations = Column(postgresql.ARRAY(postgresql.JSONB))
  optional_specialisations = Column(postgresql.ARRAY(postgresql.JSONB))
  core_course_components = Column(postgresql.ARRAY(postgresql.JSONB))
  misc_course_components = Column(postgresql.ARRAY(postgresql.JSONB))
  more_information = Column(postgresql.ARRAY(postgresql.JSONB))
